...
<head>
    ...
    <!-- Material Kit CSS -->
    <link href="<?php echo e(asset('assets/css/material-kit.css?v=2.0.7')); ?>" rel="stylesheet"/>
...
<nav class="navbar navbar-expand-md bg-success">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <div class="container">
                <form action="<?php echo e(route('users.store')); ?>" class="form-group" method="post">
                    <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('assets/js/material-kit.js?v=2.0.7')); ?>" type="text/javascript"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\EagleBankDigital\resources\views/master.blade.php ENDPATH**/ ?>